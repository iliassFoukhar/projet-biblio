...
def run_dp_all_instances():
    for i in range(2):
        ...
        for file in input_files:
            ...
            execution_command = ["./gen.exe", current_file_path, "./ResultsGenetic/{0}".format(file)]
...
def compare_scores(optimums, resulting_scores):
    ...
    for file in optimums.keys():
        best_accuracy = max(resulting_scores[file] / optimums[file], best_accuracy)
    ...
    return [correct, wrong, best_accuracy]


run_dp_all_instances()
scoresGEN = get_obtained_score("./ResultsGenetic")
optimums = get_optimums()

results = compare_scores(optimums=optimums, resulting_scores=scoresGEN)
print("############################################################")
print("Results Genetic Algorithm: ")
...
print("Most accurate answer: ", results[2], '%')
print("############################################################")
